                ...
                <div class="divide-y divide-gray-200">
                    <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        <div class="flex flex-col">
                            <label class="leading-loose capitalize">Membership ID</label>
                            <input type="text" name=""
                                class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                placeholder="ie.151505">
                        </div>
                        <div class="flex flex-col">
                            <label class="leading-loose capitalize">department name</label>
                            <input type="text" name=""
                                class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                placeholder="ie.BOXING">
                        </div>
    ...
    <div class=" col-span-4  py-3  my-4  sm:mx-auto">
        <div
            ...
            <ul class="list-disc ms-2">
                <li class=" list-item text-sm text-gray-500">start date must today or after</li>
                <li class=" list-item text-sm text-gray-500">end date not more than 3 yrs</li>
            </ul>
        </div>
    </div>
