...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/employees_css/dashborad1.css') }}">
    <link rel="stylesheet" href="{{ asset('css/employees_css/dashborad2.css') }}">
...
<body class="body bg-white dark:bg-[#0F172A]">
    <div class="fixed w-full z-30 flex shadow-sm bg-white dark:bg-[#0F172A] p-2 items-center justify-center h-16 px-10">
        <div
            class="logo ml-12 text-black  dark:text-white  transform ease-in-out duration-500 flex-none h-full flex items-center justify-center">
            ATOM GYM
            <img src={{ asset('images/logo.png') }} class="icn menuicn" id="menuicn" alt="menu-icon">
        </div>
        <!-- SPACER -->
        ...
        <div class="flex-none h-full text-center flex items-center justify-center">
            ...
            <div class="flex space-x-3 items-center px-3">
                <div class="flex-none flex justify-center items-center gap-5">
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button
                            class="px-2 py1 border border-red-500 rounded-lg text-white bg-red-500 hover:bg-red-500">Logout</button>
                    </form>
                    <div class="w-10 h-10 flex ">
                        <img src="{{ asset('images/employees_images/'.Auth::guard('employees')->user()->image) }}"
                            class=" rounded-circle w-full " alt="dp">
                    </div>
                </div>
    ...
    <aside
        ...
        <div
            ...
            <div
                ...
                <div class="transform ease-in-out duration-300 mr-12">
                    <span class="text-sm">ATOM GYM</span>
                </div>
            </div>
        </div>
        <div onclick="openNav()"
        ...
        <!-- MAX SIDEBAR-->
        <div class="max hidden px-3 text-white mt-20 flex-col space-y-2 w-full h-[calc(100vh)]">
            <div
        ...
        <div>
            ...
            <div>
                <a href="{{ route('employees.getEquipment') }}"
                    class="text-decoration-none text-white fw-bold">Equipment</a>
            </div>
